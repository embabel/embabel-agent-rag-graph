...
@SpringBootTest(classes = [MemgraphGomStoreCharacterizationTest.Config::class])
@Testcontainers
@ActiveProfiles("memgraph")
class MemgraphGomStoreCharacterizationTest : AbstractRagSearchCharacterizationTest() {
